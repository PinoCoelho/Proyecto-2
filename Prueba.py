...
def main():
    ...
    EXPLOSION_IMAGES = [
        pygame.image.load("Images/blowup1.png"), pygame.image.load("Images/blowup2.png"),
        pygame.image.load("Images/blowup3.png"),pygame.image.load("Images/blowup4.png"),
        pygame.image.load("Images/blowup5.png"),pygame.image.load("Images/blowup6.png")]
